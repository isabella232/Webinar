 ...
 */
package org.ifsoft.webinar.openfire;
...
public class PluginImpl implements Plugin, PropertyEventListener
{
    ...
    {
        Log.info("Destroy Webinar Webservice");
    ...
    public void initializePlugin(final PluginManager manager, final File pluginDirectory)
    {
        ...
        boolean webinarEnabled = JiveGlobals.getBooleanProperty("webinar.enabled", true);
        ...
        if (webinarEnabled)
        {
            ...
            try {
                Log.info("Initialize Webinar WebService ");

                context6 = new WebAppContext(null, pluginDirectory.getPath() + "/classes/webinar", "/webinar");
                ...
                Log.error("webinar disabled", e);
            }

        } else {
            Log.info("webinar disabled");
        }
    }
